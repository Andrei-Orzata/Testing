...
from InventoryApp.forms import addproduct,addlocation,moveproduct,editproduct,editlocation
from InventoryApp.models import Location,Product,Movement,Balance
